...
public class CustomerAgent extends Agent{
    // The title of the product to buy (before BookTitle)
    private String targetProductName = "";
    // The list of known seller agents
    private AID[] sellerAgents;
    private ProjectGUI myGui;

    protected void setup(){
        // Printout a welcome message
	System.out.println("-- Hallo! Customer-agent "+ getAID().getName()+" is ready to buy.");
        
        // Get the title of the product to buy as a start-up argument (recieve as an argument)
        
        myGui = new ProjectGUI(this);
	myGui.showGui();
        
        //If exist an argument
    }
    ...
    void setProductName(String s){
        targetProductName = s;
         ...
         if (targetProductName != ""){
            ...
            // Add a TickerBehaviour that schedules a request to seller agents every five seconds
